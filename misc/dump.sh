...
#(
#    echo "SET NAMES UTF8;" 
#    wget --no-check-certificate -q -O - https://memopol.lqdn.fr/europe/parliament/names |
...
#    sed -e 's/^.*"\/europe\/parliament\/deputy\/\([^"]*\)">\([^<]*\)<.*$/INSERT INTO lists SET campaign=14, name="\2", url="https:\/\/memopol.lqdn.fr\/europe\/parliament\/deputy\/\1";/' \
