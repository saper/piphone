...
<?php if (isset($view["callee"]["country"])) { ?> <li id="country"><span><?php __("Country: "); ?></span><img style="vertical-align: middle;" src="/static/ui-2.0/flag/<?php echo $view["callee"]["country"]; ?>.png" height="24" alt="<?php echo $us["country"]; ?>" /></li> <?php } ?>
   ...
   <?php if (isset($us["committee"])) { ?>
	 ...
	 <?php } ?>
	 <p id="info"><a href="https://memopol.lqdn.fr/europe/parliament/deputy/<?php echo str_replace(' ', '', ucwords(strtolower(str_replace('-', ' ', iconv("UTF-8", "US-ASCII//TRANSLIT", $us["name"]))))); ?>/"><?php __("Get more info…"); ?></a></p>
  </div>
</div>
...
<p class="action button"><a class="blue" href="/campaign/addwidget2/<?php echo $view["campaign"]["slug"]; ?>">Add a widget on your website</a></p>
