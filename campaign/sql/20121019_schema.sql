...
) ENGINE=InnoDB AUTO_INCREMENT=3804 DEFAULT CHARSET=utf8 COMMENT='The call history';
...
CREATE TABLE `lists` (
  ...
  KEY `enabled` (`enabled`)
) ENGINE=MyISAM AUTO_INCREMENT=6097 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-10-19 20:05:41
